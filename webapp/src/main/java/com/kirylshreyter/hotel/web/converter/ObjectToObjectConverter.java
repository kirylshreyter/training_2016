package com.kirylshreyter.hotel.web.converter;
...
import com.kirylshreyter.hotel.web.util.ObjectIdentifier;
...
public class ObjectToObjectConverter implements Converter<Object, Object> {
	...
	private Object ObjectToModel(Object object)
		...
		String model = objectIdentifier.identifyAnObject(object).toString();
